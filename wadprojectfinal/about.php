...
<div class="card" onclick="window.location.href='Portfolios/Maryam/index.php'">
    <div class="img-box">
        <img src="Portfolios/Maryam/images/profile pic.webp" alt="Maryam">
    </div>
    <h2>Maryam Uzair</h2>
    ...
    <p>Created the Home Page with complete frontend and backend work.</p>
        ...
        <!-- CARD 2 -->
<div class="card" onclick="window.location.href='Portfolios/Aimen/aimen.php'">
    <div class="img-box">
        <img src="Portfolios/Aimen/image/pic.jpg" alt="Aimen">
    </div>
    <h2>Aimen Haque</h2>
    <h4>Frontend & Backend Developer</h4>
...
<!-- CARD 3 -->
<div class="card" onclick="window.location.href='Portfolios/Eman/index.php'">
    <div class="img-box">
        <img src="Portfolios/Eman/Images/hero.png" alt="Eman">
    </div>
    <h2>Eman Aleem</h2>
    <h4>Frontend & Backend Developer</h4>
...
<!-- CARD 4 -->
<div class="card" onclick="window.location.href='Portfolios/Arfa/index.php'">
    <div class="img-box">
        <img src="Portfolios/Arfa/images/Arfa pic.jpeg" alt="Arfa">
    </div>
    <h2>Arfa Zain</h2>
    <h4>Frontend & Backend Developer</h4>
